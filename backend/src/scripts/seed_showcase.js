...
const BUSINESS = {
    name: process.env.SHOWCASE_BUSINESS_NAME || 'SmartOps Showcase Store',
    phone: process.env.SHOWCASE_BUSINESS_PHONE || '9888877777',
    password: process.env.SHOWCASE_BUSINESS_PASSWORD || 'showcase123',
    type: process.env.SHOWCASE_BUSINESS_TYPE || 'kirana',
};

const CUSTOMERS = [
    { name: 'Asha Singh', phone: '9000000001', segment: 'regular' },
    { name: 'Ravi Kumar', phone: '9000000002', segment: 'regular' },
    { name: 'Neha Verma', phone: '9000000003', segment: 'regular' },
    { name: 'Sanjay Patel', phone: '9000000004', segment: 'occasional' },
    { name: 'Kiran Shah', phone: '9000000005', segment: 'occasional' },
    { name: 'Pooja Jain', phone: '9000000006', segment: 'dormant' },
    { name: 'Vikram Joshi', phone: '9000000007', segment: 'dormant' },
    { name: 'Meera Iyer', phone: '9000000008', segment: 'new' },
    { name: 'Arjun Nair', phone: '9000000009', segment: 'regular' },
    { name: 'Sneha Rao', phone: '9000000010', segment: 'occasional' },
    { name: 'Farhan Ali', phone: '9000000011', segment: 'new' },
    { name: 'Komal Gupta', phone: '9000000012', segment: 'regular' },
];
...
const PRODUCTS = [
    {
        ...
        focus: ['reorder', 'top'],
        batches: [
            { batchNo: 'ATTA-A1', receivedQty: 42, remainingQty: 5, expiryOffsetDays: 180, receivedDaysAgo: 34 },
            { batchNo: 'ATTA-B1', receivedQty: 28, remainingQty: 14, expiryOffsetDays: 240, receivedDaysAgo: 8 },
        ],
    },
    {
        key: 'rice',
        ...
        focus: ['steady'],
        batches: [
            { batchNo: 'RICE-A1', receivedQty: 26, remainingQty: 12, expiryOffsetDays: 210, receivedDaysAgo: 24 },
        ],
    },
    {
        key: 'salt',
        ...
        focus: ['top'],
        batches: [
            { batchNo: 'SALT-A1', receivedQty: 90, remainingQty: 30, expiryOffsetDays: 300, receivedDaysAgo: 40 },
        ],
    },
    {
        key: 'biscuits',
        ...
        focus: ['top', 'basket'],
        batches: [
            { batchNo: 'BISC-A1', receivedQty: 84, remainingQty: 11, expiryOffsetDays: 120, receivedDaysAgo: 18 },
        ],
    },
    {
        key: 'chips',
        ...
        reorderLevel: 25,
        saleVelocity: 'high',
        focus: ['reorder', 'basket', 'opportunity'],
        batches: [
            { batchNo: 'CHIP-A1', receivedQty: 70, remainingQty: 6, expiryOffsetDays: 75, receivedDaysAgo: 12 },
        ],
    },
    {
        key: 'maggi',
        ...
        reorderLevel: 18,
        saleVelocity: 'high',
        focus: ['out_of_stock', 'reorder'],
        batches: [
            { batchNo: 'MAGGI-A1', receivedQty: 36, remainingQty: 0, expiryOffsetDays: 90, receivedDaysAgo: 15 },
        ],
    },
    {
        key: 'juice',
        ...
        reorderLevel: 10,
        saleVelocity: 'high',
        focus: ['opportunity', 'reorder', 'summer'],
        batches: [
            { batchNo: 'JUICE-A1', receivedQty: 24, remainingQty: 4, expiryOffsetDays: 10, receivedDaysAgo: 14 },
        ],
    },
    {
        key: 'butter',
        ...
        focus: ['expiry'],
        batches: [
            { batchNo: 'BUTTER-A1', receivedQty: 18, remainingQty: 4, expiryOffsetDays: 3, receivedDaysAgo: 12, wastageQty: 1 },
        ],
    },
    {
        key: 'cheese',
    ...
    },
    {
        ...
        focus: ['slow'],
        batches: [
            { batchNo: 'GHEE-A1', receivedQty: 16, remainingQty: 10, expiryOffsetDays: 260, receivedDaysAgo: 28 },
        ],
    },
    {
        key: 'toothpaste',
        ...
        focus: ['steady'],
        batches: [
            { batchNo: 'COLGATE-A1', receivedQty: 34, remainingQty: 17, expiryOffsetDays: 300, receivedDaysAgo: 22, returnQty: 2 },
        ],
    },
    {
        key: 'detergent',
    ...
    },
    {
        ...
        focus: ['steady'],
        batches: [
            { batchNo: 'SOAP-A1', receivedQty: 40, remainingQty: 19, expiryOffsetDays: 320, receivedDaysAgo: 26 },
        ],
    },
    {
        key: 'cold_drink_candidate',
        name: 'Paper Boat Aamras 1L',
        brand: 'Paper Boat',
        barcode: '8901063094110',
        category: 'Beverage',
        unit: 'pcs',
        sellingPrice: 140,
        costPrice: 121,
        ...
        focus: ['summer'],
        batches: [
            { batchNo: 'PBOAT-A1', receivedQty: 12, remainingQty: 9, expiryOffsetDays: 95, receivedDaysAgo: 10 },
        ],
    },
    {
        key: 'tea',
    ...
    },
    {
        ...
        focus: ['reorder'],
        batches: [
            { batchNo: 'OIL-A1', receivedQty: 32, remainingQty: 8, expiryOffsetDays: 120, receivedDaysAgo: 20 },
        ],
    },
];
...
function choosePaymentMode(customer) {
    ...
    if (customer.segment === 'regular') return choose(['upi', 'upi', 'cash', 'credit']);
    if (customer.segment === 'occasional') return choose(['cash', 'upi']);
    return choose(['cash', 'credit']);
}

function chooseDaysAgo(product) {
    if (product.focus.includes('summer')) return randInt(0, 10);
    if (product.saleVelocity === 'high') return randInt(0, 18);
    if (product.saleVelocity === 'medium') return randInt(5, 34);
    return randInt(20, 58);
}

function splitIntoSaleEvents(totalQty, product) {
    const chunks = [];
...
async function resolveOrCreateBusiness(client) {
    const { rows } = await client.query(
        'SELECT id, name, phone, type FROM businesses WHERE phone = $1',
        [BUSINESS.phone]
    );
...
async function resetBusinessData(client, businessId) {
    console.log(`[showcase] Resetting operational data for business ${businessId}`);
        ...
        for (const plan of product.batches) {
            ...
            if (returnQty > 0) {
                await client.query(
                    ...
                    [uuidv4(), productId, batchId, returnQty, createdAt + 8 * DAY, now]
                );
            }
            ...
            splitIntoSaleEvents(soldQty, product).forEach(({ qty, daysAgo }) => {
                saleEvents.push({
                    qty,
                    daysAgo,
...
async function main() {
    ...
    try {
        ...
        console.log(`[showcase] Target business: ${business.name} (${business.phone})`);

        if (shouldReset) {
            await resetBusinessData(client, business.id);
        } else {
            console.log('[showcase] Running without --reset. Existing operational data will be preserved and new showcase data will be appended.');
        }
        ...
        console.log('[showcase] Showcase dataset created successfully.');
        console.log(`[showcase] Login phone: ${business.phone}`);
        console.log(`[showcase] Login password: ${BUSINESS.password}`);
        console.log(`[showcase] Products: ${products.length}`);
        console.log(`[showcase] Customers: ${customers.length}`);
        console.log(`[showcase] Orders: ${orderCount}`);
        console.log('[showcase] Covers app + web dashboard scenarios: low stock, out of stock, reorder urgency, stockout risk, expiry risk, dead stock, top products, customer segments, payment mix, and seasonal/product opportunity signals.');
    } catch (error) {
